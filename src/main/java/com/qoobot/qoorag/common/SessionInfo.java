...
public class SessionInfo implements Serializable {
    ...
    public Long apiKeyId;           // API Key ID（仅 API Key 调用有，用于限流识别）
    public Integer apiKeyRateLimit; // API Key 速率限制（次/分钟，仅 API Key 调用有）
    ...
    public Integer getApiKeyRateLimit() { return apiKeyRateLimit; }
